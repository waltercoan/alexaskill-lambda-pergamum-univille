...
This is a sample template for alexaskilluniville - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name alexaskilluniville --tail
```
...
```bash
aws cloudformation delete-stack --stack-name alexaskilluniville
```
